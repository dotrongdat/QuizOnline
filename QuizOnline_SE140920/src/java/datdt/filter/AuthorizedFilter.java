...
public class AuthorizedFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(disallowDirectAccess.containsKey(resource)){
            ...
            if(authenMap.containsKey(resource)&&authorizeMap.containsKey(resource)){
                if(account.isAdmin()){
                    url=authorizeMap.get(resource);
                }else{
                    url=authenMap.get(resource);
                }
            }else if(authenMap.containsKey(resource)){
                if(!account.isAdmin()){
                    url=authenMap.get(resource);
                }else{
                    url="HomePage";
            ...
            }else if(authorizeMap.containsKey(resource)){
                 if(account.isAdmin()){
                    url=authorizeMap.get(resource);
                }else{
                    url="HomePage";
